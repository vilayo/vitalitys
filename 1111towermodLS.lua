...
return function(context)
    ...
    MainTab._VitalityCharacterTab = Window:CreateTab("Character", "user")
    local TeleportsTab = Window:CreateTab("Teleports", "list")
    local ItemVisualsTab = Window:CreateTab("Item ESP", "key")
    local PlayerVisualsTab = Window:CreateTab("Player ESP", "info")
    local PlayerToolsTab = Window:CreateTab("Players", "list")
    ...
    pcall(function()
        local sniperTab = Window:CreateTab("Sniper", "info")
    ...
    pcall(function()
        -- Visible Settings page. No icon argument intentionally uses the library's
        -- built-in fallback diamond until the dedicated Settings artwork is uploaded.
        ...
        -- NOTIFICATIONS ---------------------------------------------------------
        -- These are the same shared notification controls that previously appeared
        -- under Personalization; only their parent tab has changed.
        local NotificationSettings = Window.NotificationSettings or {}
        ...
        NotificationsSection:CreateSlider({
            ...
            Increment = 0.5,
            Suffix = "s",
            CurrentValue = tonumber(NotificationSettings.Duration) or 4,
            Callback = function(value)
        ...
        NotificationsSection:CreateDropdown({
            ...
            CurrentOption = NotificationSettings.Position or "Top right",
            Callback = function(value)
        ...
        NotificationsSection:CreateSlider({
            ...
            Increment = 1,
            Suffix = "%",
            CurrentValue = tonumber(NotificationSettings.Opacity) or 100,
            Callback = function(value)
