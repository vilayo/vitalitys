...
function WindowMethods:_setupCommandBar()
    ...
    local function updateCommandInputHeight()
        ...
        local availableWidth = math.max(120, width - 104)
        ...
        local targetHeight = math.clamp(math.ceil(measuredHeight) + 18, baseInputHeight, maxInputHeight)
