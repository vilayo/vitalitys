...
return function(context)
    ...
    pcall(function()
        -- Visible Settings tab. Omitting an icon deliberately uses the library's
        -- fallback diamond until the dedicated Settings artwork is uploaded.
        ...
        -- The Settings icon is intentionally omitted so CreateTab uses the
        -- library's built-in fallback diamond until dedicated artwork is supplied.
        do
