-- vitality's hub / Flick module LS
-- Live Service module version: 2.9.0-LS
--
-- IMPORTANT:
...
return function(context)
    ...
    -- ============================================================
    -- GUN MODS â€” LIVE GUNFRAMEWORK CONFIG TABLE
    -- ============================================================
    ...
    -- ============================================================
    -- UI â€” same overall organization/customization pattern as Tower
    -- ============================================================
    ...
    local PlayerVisualsTab = Window:CreateTab("Player ESP", "player-esp")
    local CombatTab = Window:CreateTab("Combat", "combat")
    local KnifeTab = Window:CreateTab("Knife", "knife")

    local MainSection = MainTab:CreateSection({
        Name = "Flick", Icon = "flick",
    ...
    local SilentAimSection =
        CombatTab:CreateSection({
            Name = "Silent Aim", Icon = "silent-aim",
    ...
    local TriggerbotSection =
        CombatTab:CreateSection({
            Name = "Triggerbot", Icon = "triggerbot",
    ...
    PredictionSection:CreateParagraph({
        Title = "Ballistics",
        Content = "Uses Flick's real projectile formula: speed = BulletForce Ã— 20.2244897959. Force 130 is approximately 2629 studs/s before gravity.",
    })

    local GunModsSection =
        CombatTab:CreateSection({
            Name = "Gun Mods", Icon = "gun",
    ...
    local ESPFilters =
        PlayerVisualsTab:CreateSection({
            Name = "ESP Filters", Icon = "visibility",
    ...
    local Awareness =
        PlayerVisualsTab:CreateSection({
            Name = "Threat Awareness", Icon = "threat",
    ...
    local Chams =
        PlayerVisualsTab:CreateSection({
            Name = "Highlight Chams", Icon = "chams",
    ...
    local InPlaySection =
        PlayerVisualsTab:CreateSection({
            Name = "Players In Play", Icon = "players",
