-- vitality's hub / Murder Mystery 2 LS
-- Module version: 4.4-LS
...
return function(context)
    ...
    local function roleTextForRecord(record)
        ...
        if dead then
            return "DEAD â€¢ " .. string.upper(role)
        end
    ...
    xpcall(function()
        ...
        local FunSection =
            MiscTab:CreateSection({
                Name = "Target Tools", Icon = "target-player",
        ...
        TargetInput =
            FunSection:CreateInput({
                ...
                PlaceholderText = "gr â†’ graciepoo2",
                CurrentValue = "",
                CharacterLimit = 32,
                OnEnter = true,
        ...
        local PlayerToolsSection =
            MiscTab:CreateSection({
                Name = "Role / Physics", Icon = "protection",
        ...
        CoinStatsToggle =
            CoinStatsSection:CreateToggle({
                ...
                Info = "Show or hide a draggable stats window. The Ã— button also closes it.",
                CurrentValue = false,
    ...
    local RoundSection =
        RolesTab:CreateSection({
            Name = "Round Information", Icon = "info",
    ...
    if RoleRemote
        ...
        RoundInfo:Set({
            Content = "Connected to PlayerDataChanged â€¢ waiting for the next role snapshot.",
        })
    else
        RoundInfo:Set({
    ...
    (function()
        ...
        local AimSection =
            CombatTab:CreateSection({
                Name = "Aim Assistance", Icon = "silent-aim",
