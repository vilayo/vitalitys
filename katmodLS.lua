...
return function(context)
    ...
    local ok, failure = pcall(function()
        local tab = Window:CreateTab("KAT", "kat")
        local aim = tab:CreateSection({Name = "Silent aim", Icon = "silent-aim", Side = "Left"})
        ...
        local diagnostics = tab:CreateSection({Name = "Diagnostics", Icon = "bug", Side = "Right"})
