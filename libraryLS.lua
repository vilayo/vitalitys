...
Library.PremiumIconAssets = {
    -- Exact Creator Dashboard names supplied by the owner.
    ...
    esp = "rbxassetid://78498493210038",
    players = "rbxassetid://107762344600668",
    sniper = "rbxassetid://83030488568905",

    -- Reusable compatibility aliases. These point at the same uploaded artwork.
