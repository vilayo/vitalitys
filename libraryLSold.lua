...
Library.PremiumIconAssets = {
    main = "rbxassetid://116664037888607",
    character = "rbxassetid://87623463253011",
    teleports = "rbxassetid://93690681894231",
    items = "rbxassetid://118238817418916",
    player_esp = "rbxassetid://78498493210038",
    players = "rbxassetid://107762344600668",
    sniper = "rbxassetid://83030488568905",
}
...
local function createPremiumIcon(parent, name, asset)
    ...
    local function refreshLoadedState()
    ...
    pcall(function()
        imageLabel:GetPropertyChangedSignal("IsLoaded"):Connect(refreshLoadedState)
    end)
    task.defer(refreshLoadedState)
